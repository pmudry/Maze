...
import maze.solvers.AStar_BEGIN;
...
public class GraphicDisplay {
	 ...
	 * @param kl
	 */
	public void registerKeyListener(KeyboardListener kl) {
		disp.registerKeyListener(kl);
	}
	 ...
	 * solver algorithm such as the one implemented in {@link AStar_BEGIN}
	 * 
